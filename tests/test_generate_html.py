...
from pi_agent_transcripts import (
    generate_html,
    detect_github_repo,
...
class TestRenderContentBlock:
    ...
    def test_tool_result_with_commit(self, snapshot_html):
        ...
        import pi_agent_transcripts

        old_repo = pi_agent_transcripts._github_repo
        pi_agent_transcripts._github_repo = "example/repo"
        try:
            block = {
                "type": "tool_result",
            ...
            pi_agent_transcripts._github_repo = old_repo
...
class TestSessionGistOption:
    ...
    def test_session_gist_creates_gist(self, monkeypatch, tmp_path):
        ...
        from pi_agent_transcripts import cli
        import subprocess
        ...
        monkeypatch.setattr(
            "pi_agent_transcripts.tempfile.gettempdir", lambda: str(tmp_path)
        )
...
class TestVersionOption:
    ...
    def test_version_long_flag(self):
        ...
        expected_version = importlib.metadata.version("pi-agent-transcripts")
        assert result.exit_code == 0
